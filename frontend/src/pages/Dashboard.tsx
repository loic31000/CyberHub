...
const BentoCard = ({ item, onClick }: { item: any, onClick: () => void }) => {
      ...
      <div className="relative z-10 p-5 flex flex-col h-full justify-between">
        <div className="flex justify-between items-start mb-4">
          ...
          {isActive ? (
            ...
            <span className="text-[10px] uppercase tracking-wider text-text-muted bg-gray-800/50 px-2 py-1 rounded">Bientôt</span>
          )}
        </div>
