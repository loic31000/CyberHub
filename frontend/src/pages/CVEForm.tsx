    ...
    <div className="p-6 max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="grid grid-cols-3 gap-4">
          <div>
            <label className="block text-sm text-text-secondary mb-1">{`CVSS:`}</label>
            <input
              type="number"
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm text-text-secondary mb-1">{`Produits affectés`}</label>
            <input
              type="text"
              className="input-cyber w-full px-3 py-2 text-sm"
          ...
          <div>
            <label className="block text-sm text-text-secondary mb-1">{`Publié le`}</label>
            <input
              type="date"
              className="input-cyber w-full px-3 py-2 text-sm"
        ...
        <div className="flex gap-3 pt-2">
          ...
          >
            <Save size={15} />
            {saving ? `Sauvegarde…` : isEdit ? `Enregistrer` : `Nouvelle CVE`}
          </button>
          <button
            type="button"
